...
public class Parser {
    ...
    private final ArrayList<String> syntaxOutput = new ArrayList<>();
    private final ArrayList<String> tmpOutput = new ArrayList<>();
    private final ArrayList<Error> errorOutput = new ArrayList<>();
    private final ArrayList<Error> tmpErrorOutput = new ArrayList<>();
    private static final HashMap<Integer, SymbolTable> symbolTables = new HashMap<>();
    ...
    private Def parseVarDef() {
        ...
        if (curToken.equals("=")) {
            ...
            if (curToken.equals("getint")) {
                GetIntStmt getIntStmt = new GetIntStmt(new Lvalue(ident));
                next();     // read 'getint'
                next();     // read '('
    ...
    private MulExp parseMulExp() {
        ...
        while (curToken.equals("*") || curToken.equals("/") || curToken.equals("%") || curToken.equals("bitand")) {
